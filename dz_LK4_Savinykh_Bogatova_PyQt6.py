...
class MainWindow(QWidget):
    ...
    def initializeUI(self):
        ...
        self.setGeometry(900, 150, 1000, 900)
        self.setWindowTitle("Салам")
    ...
    def setUpMainWindow(self):
        ...
        hello_label.setText("САО БРАТИК!")
        hello_label.move(500, 15)

        image = r"C:\Users\timachk\Desktop\hi.jpg"
        try:
            with open(image):
...
class MainWindo(QWidget):
    ...
    def initializeUI(self):
        ...
        self.setGeometry(300, 150, 500, 700)  # другое положение
    ...
    def createImageLabels(self):
        ...
        images = [
            r"C:\Users\timachk\Desktop\liz.jpg",
